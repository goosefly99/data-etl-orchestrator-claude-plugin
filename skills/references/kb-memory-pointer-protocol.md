...
6. If no match: ask the user whether to create a new KB or abort.
7. After resolving: overwrite the pointer file with the correct id and set `Last verified` to today's date. Update the MEMORY.md index line to match.
